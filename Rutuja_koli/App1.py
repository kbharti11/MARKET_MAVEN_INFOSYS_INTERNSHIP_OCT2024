...
ordinal_encoder = joblib.load('C:/Users/HP/Desktop/infosys_springboard/final code/New folder/ordinal_encoder.pkl')
onehot_encoder = joblib.load('C:/Users/HP/Desktop/infosys_springboard/final code/New folder/onehot_encoder.pkl')
scaler = joblib.load('C:/Users/HP/Desktop/infosys_springboard/final code/New folder/standard_scaler.pkl')

# Load label encoders
item_identifier_encoder = joblib.load('C:/Users/HP/Desktop/infosys_springboard/final code/New folder/Item_Identifier_label_encoder.pkl')
outlet_identifier_encoder = joblib.load('C:/Users/HP/Desktop/infosys_springboard/final code/New folder/Outlet_Identifier_label_encoder.pkl')

# Load the saved Gradient Boosting model
best_gb_model = joblib.load('C:/Users/HP/Desktop/infosys_springboard/final code/New folder/xgboost_model.pkl')
...
def main():
    ...
    st.set_page_config(
        page_title='Super Market Sales Prediction App',
        page_icon='🛒',
        layout='wide',
    ...
    st.title('🛒 Super Market Prediction App')
